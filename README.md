...
You can use [Solana Verify CLI](https://github.com/Ellipsis-Labs/solana-verifiable-build) to verify that the program deployed at `phNX2ZY31wq9NCXMfY9ptouoqB3Mor8oe3QE96V6QKn` matches the code in this repository. After installing the CLI, run:

```
solana-verify verify-from-repo -um --program-id phNX2ZY31wq9NCXMfY9ptouoqB3Mor8oe3QE96V6QKn https://github.com/Ellipsis-Labs/phoenix-v1
```
